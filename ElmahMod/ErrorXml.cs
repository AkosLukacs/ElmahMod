...
namespace Elmah
{
    ...
    public static class ErrorXml
    {
        ...
        private static void ReadXmlAttributes(XmlReader reader, Error error)
        {
            ...
            error.TraceMsg = reader.GetAttribute("traceMsg");
        }
        ...
        private static void ReadInnerXml(XmlReader reader, Error error)
        {
            ...
            while (reader.IsStartElement())
            {
                ...
                switch (reader.Name)
                {
                    ...
                    case "innerError"      : error.InnerError = Decode(reader); continue;   //done reading, continue
                    //case "data"            : error.Data = Decode(reader); break;
        ...
        private static void WriteXmlAttributes(Error error, XmlWriter writer)
        {
            ...
            WriteXmlAttribute(writer, "traceMsg", error.TraceMsg);
        }
