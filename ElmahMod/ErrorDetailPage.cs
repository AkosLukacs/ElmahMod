...
namespace Elmah
{
    ...
    internal sealed class ErrorDetailPage : ErrorPageBase
    {
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            if (_errorEntry != null)
                RenderError(writer, _errorEntry.Error);
            else
        ...
        private void RenderError(HtmlTextWriter writer, Error error)
        {
            Debug.Assert(writer != null);
            ...
            RenderErrorCore(writer, error, true);

            base.RenderContents(writer);
        }

        private void RenderErrorCore(HtmlTextWriter writer, Error error, Boolean outerMost)
        {
            ...
            if (outerMost)    //error time is set in the constructor of the Error class, so should be the same for inner exceptions...
            {
                //
            ...
            if (!String.IsNullOrEmpty(error.TraceMsg))
            {
            ...
            if (error.InnerError != null)
            {
                ...
                RenderErrorCore(writer, error.InnerError, false);
